...
| 4 | Understanding Embeddings | 25 min | [Notebook 1](notebooks/01_embeddings.ipynb) + Exercise 1: [preprocess_text](src/data_models.py#L69), [generate_embeddings](src/preprocess.py#L135) |
...
| 6 | Evaluating Topic Search Retrieval | 20 min | [Notebook 3](notebooks/03_search_evaluation.ipynb) + Exercise 3: [compute_precision_at_k](src/evaluation.py#L68), [compute_recall_at_k](src/evaluation.py#L93), [compute_random_baseline](src/evaluation.py#L109) |
